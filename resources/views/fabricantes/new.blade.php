...
<body>
    ...
    <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Agregar Nuevo Fabricante</h2>
            <p class="mt-2 text-lg leading-8 text-gray-600">Ingrese la información del Fabricante</p>
        </div>
        <form action="{{ route('fabricante.store') }}" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
            @csrf
            @method('POST')
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-2.5">
                        <input type="date" name="fechaInicioOperacion" id="fechaInicioOperacion" autocomplete="date"
                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
            </div>
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div class="mt-8 bg-white dark:bg-gray-200 overflow-hidden shadow sm:rounded-lg">
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="card">
                    <h3 class="card-header">Agregar nuevo Fabricante</h3>
                    <div class="card-body">
                        <p class="card-text">
                        ...
                        <form action="{{ route('fabricante.store') }}" method="POST">
                            ...
                            <input type="date" name="fechaInicioOperacion" class="form-control">

                            ...
                            <div class="card-body">
                                <p class="card-text">
                                    ...
                                    <form action="{{route('fabricante.update', $fabricante['codigoFabricante'])}}" method="POST">
                                        ...
                                        <input name="codigoFabricante" readonly value="{{$fabricante['codigoFabricante']}}"  type="number" name="descripcion" class="form-control">
        
                                        <label for="">Descripcion</label>
                                        <input value="{{$fabricante['descripcion']}}"  type="text" name="descripcion" class="form-control">
                                        
                                        <label for="">Fecha de inicio de operacion</label>
                                        <input value="{{$fabricante['fechaInicioOperacion']}}"  type="date" name="fechaInicioOperacion" class="form-control">

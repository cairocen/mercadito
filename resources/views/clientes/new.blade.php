...
<body>
    ...
    <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Agregar Cliente</h2>
            <p class="mt-2 text-lg leading-8 text-gray-600">Ingrese la información del Cliente</p>
        </div>
        <form action="{{ route('cliente.store') }}" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
            @csrf
            @method('POST')
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    <label for="correo" class="block text-sm font-semibold leading-6 text-gray-900">Correo
                        Electrónico</label>
                    <div class="mt-2.5">
    ...
    <!--<div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div class="mt-8 bg-white dark:bg-gray-200 overflow-hidden shadow sm:rounded-lg">
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="card">
                    <h3 class="card-header">Agregar nuevo Cliente</h3>
                    <div class="card-body">
                        <p class="card-text">
